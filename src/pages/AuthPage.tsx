...
export default function AuthPage() {
  const { requestCode, verifyCode, pendingPhone } = useAuth();
      ...
      <div className="flex-1 flex flex-col justify-center px-6 py-8 max-w-sm mx-auto w-full">
        ...
        {step === 'phone' ? (
          ...
          <div className="space-y-4">
            ...
            />
            {codeError && (
              <p className="text-sm text-destructive text-center">Неверный код. Для теста используйте 1234</p>
            )}
            <Button
              className="w-full h-12 rounded-xl bg-primary text-primary-foreground font-medium"
